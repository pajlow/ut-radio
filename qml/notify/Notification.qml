...
Rectangle {
    ...
    Row {
        ...
        Icon {
            ...
            width: units.gu(4)
            height: units.gu(4)
            color: notification.activeNotification && (notification.activeNotification.type === "warning" ? "orange" : (notification.activeNotification.type === "error" ? "red" : "green")) || "white"
            name: notification.activeNotification && (notification.activeNotification.type === "warning" ? "dialog-warning-symbolic" : (notification.activeNotification.type === "error" ? "dialog-error-symbolic" : "info")) || "info"
        }
